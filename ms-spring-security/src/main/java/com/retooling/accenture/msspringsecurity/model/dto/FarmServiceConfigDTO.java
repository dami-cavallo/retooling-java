...
public class FarmServiceConfigDTO {
    ...
    protected FarmServiceConfigDTO(){

    }
    public FarmServiceConfigDTO(double purchasePriceChicken, double purchasePriceEgg, double sellPriceChicken, double sellPriceEgg, int amountDaysToPutEggs, int amountEggsToPut, int chickensDaysToDie, int eggsDaysToBecomeChicken) {
